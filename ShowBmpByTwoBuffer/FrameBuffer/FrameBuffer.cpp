 ...
 * 返回值   : -1:失败，  0：成功, 
 */
int FrameBuffer::BufferShowBmp( char* disBuffer, int dw, int dh, int x, int y, char *bmpBuff, int bw, int bh)
{
    int drawW = 0;
    int drawH = 0;
    if ( x + bw > dw )
 ...
 * 返回值   : -1:失败，  0：成功
 */
int FrameBuffer::BufferClearColor(char* disBuffer, int dw, int dh, int x, int y, int w, int h, int r, int g, int b)
{
    int drawW = 0;
    int drawH = 0;
    if ( x + w > dw )
